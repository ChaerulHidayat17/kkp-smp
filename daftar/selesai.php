...
<body
    class="bg-gradient-to-r from-blue-600 via-blue-500 to-blue-400 flex items-center justify-center min-h-screen p-4 text-white text-center">
    <div
        class="p-8 rounded-lg shadow-2xl bg-white bg-opacity-90 backdrop-blur-lg w-full max-w-2xl border border-gray-300 relative overflow-hidden text-gray-900">
        ...
        <p class="mt-6 text-xl md:text-2xl font-bold text-green-600 animate-pulse">GRATIS!!! Semua Biaya Pendidikan
            Ditanggung!</p>
        ...
        <button onclick="togglePopup()"
            class="mt-6 px-8 py-4 bg-blue-600 text-white font-bold rounded-full shadow-lg hover:bg-blue-700 transition-transform transform hover:scale-105 cursor-pointer">Info
            Lebih Lanjut</button>

        <!-- Tombol Kembali ke Home -->
        <button onclick="goHome()"
            class="mt-4 px-8 py-4 bg-blue-600 text-white font-bold rounded-full shadow-lg hover:bg-blue-700 transition-transform transform hover:scale-105 cursor-pointer">Kembali
            ke Home</button>
    </div>

    <!-- Pop-up Box -->
    <div id="popupBox"
        class="hidden fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 backdrop-blur-sm">
        <div class="bg-white p-6 rounded-lg shadow-2xl w-96 text-center border border-gray-300">
            ...
            <div class="flex justify-center mt-6">
                <button onclick="togglePopup()"
                    class="bg-red-500 text-white px-6 py-3 rounded-full font-bold hover:bg-red-600 transition">Tutup</button>
            </div>
        </div>
    </div>
    ...
    function goHome() {
        window.location.href = "../index.php"; // Ganti dengan URL halaman utama
    }
    </script>
</body>
